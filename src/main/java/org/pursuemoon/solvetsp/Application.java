...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        if (index.equals("all")) {
            testAll(calTime, visible, populationSize, crossoverProbability, mutationProbability, topX, topY, topZ,
            ...
            try {
                ...
                testCase(kase, calTime, visible, populationSize, crossoverProbability, mutationProbability, topX, topY, topZ,
                        leastGenerationNumber, bestQueueSize, leastBestStayGeneration, maxFitnessDifferenceBetweenBestAndWorst);
            } catch (NumberFormatException ne) {
    ...
    private static void printHelp() {
        ...
        help += "--gen Number         Designate the number of generations which\n" +
                ...
                "                   many generations. Default value is 2000.\n";
